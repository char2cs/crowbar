      ...
      children: [
        {
          ...
          children: [
            {
              name: 'crowbar',
              path: 'api/cmd/crowbar',
              isDir: true,
              children: [{ name: 'main.go', path: 'api/cmd/crowbar/main.go', isDir: false }],
            },
          ],
        },
        {
          ...
          children: [
            {
              name: 'api',
              path: 'api/internal/api',
              isDir: true,
              children: [
                {
                  name: 'v0',
                  path: 'api/internal/api/v0',
                  isDir: true,
                  children: [
                    {
                      name: 'router.go',
                      path: 'api/internal/api/v0/router.go',
                      isDir: false,
                      gitStatus: 'modified',
                    },
                    {
                      name: 'workspaces_handler.go',
                      path: 'api/internal/api/v0/workspaces_handler.go',
                      isDir: false,
                    },
                    {
                      name: 'git_handler.go',
                      path: 'api/internal/api/v0/git_handler.go',
                      isDir: false,
                      gitStatus: 'added',
                    },
                    {
                      name: 'ws_git_handler.go',
                      path: 'api/internal/api/v0/ws_git_handler.go',
                      isDir: false,
                      gitStatus: 'added',
                    },
                  ],
                ...
                {
                  name: 'middleware',
                  path: 'api/internal/api/middleware',
                  isDir: true,
                  children: [
                    {
                      name: 'chaos.go',
                      path: 'api/internal/api/middleware/chaos.go',
                      isDir: false,
                      gitStatus: 'added',
                    },
                  ],
            ...
            },
            {
              ...
              children: [
                ...
                { name: 'loader.go', path: 'api/internal/fixtures/loader.go', isDir: false },
                {
                  ...
                  path: 'api/internal/fixtures/workspaces.json',
                  isDir: false,
                },
                {
                  name: 'git-log.json',
                  path: 'api/internal/fixtures/git-log.json',
                  isDir: false,
                  gitStatus: 'added',
                },
              ],
          ...
          children: [
            {
              ...
              children: [
                {
                  name: 'git',
                  path: 'web/src/features/git',
                  isDir: true,
                  children: [
                    {
                      name: 'components',
                      path: 'web/src/features/git/components',
                      isDir: true,
                      children: [
                        {
                          name: 'git-tab.tsx',
                    ...
                    {
                      name: 'api',
                      path: 'web/src/features/git/api',
                      isDir: true,
                      children: [
                        {
                          name: 'git-commits-api.ts',
                          path: 'web/src/features/git/api/git-commits-api.ts',
                          isDir: false,
                          gitStatus: 'modified',
                        },
                        {
                          name: 'git-status-api.ts',
                          path: 'web/src/features/git/api/git-status-api.ts',
                          isDir: false,
                          gitStatus: 'modified',
                        },
                        {
                          name: 'git-branches-api.ts',
                          path: 'web/src/features/git/api/git-branches-api.ts',
                          isDir: false,
                          gitStatus: 'modified',
                        },
                      ],
                ...
                {
                  name: 'settings',
                  path: 'web/src/features/settings',
                  isDir: true,
                  children: [
                    {
                      name: 'components',
                      path: 'web/src/features/settings/components',
                      isDir: true,
                      children: [
                        {
                          name: 'tabs',
                          path: 'web/src/features/settings/components/tabs',
                          isDir: true,
                          children: [
                            {
                              name: 'developer-settings.tsx',
            ...
            },
            {
              ...
              children: [
                {
                  name: 'handlers',
                  path: 'web/src/mocks/handlers',
                  isDir: true,
                  children: [
                    {
                      name: 'git.ts',
                      path: 'web/src/mocks/handlers/git.ts',
                      isDir: false,
                      gitStatus: 'modified',
                    },
                    {
                      name: 'workspaces.ts',
                      path: 'web/src/mocks/handlers/workspaces.ts',
                      isDir: false,
                      gitStatus: 'modified',
                    },
                  ],
          ...
          children: [
            { name: 'schema.ts', path: 'src/db/schema.ts', isDir: false },
            {
              ...
              children: [
                ...
                {
                  name: '002_add_oauth.sql',
                  path: 'src/db/migrations/002_add_oauth.sql',
                  isDir: false,
                  gitStatus: 'added',
                },
              ],
          ...
          children: [
            { name: 'main.rs', path: 'src-tauri/src/main.rs', isDir: false },
            {
              ...
              children: [
                ...
                {
                  name: 'pty.rs',
                  path: 'src-tauri/src/shell/pty.rs',
                  isDir: false,
                  gitStatus: 'added',
                },
              ],
            },
            {
              ...
              children: [
                ...
                {
                  name: 'watcher.rs',
                  path: 'src-tauri/src/fs/watcher.rs',
                  isDir: false,
                  gitStatus: 'modified',
                },
              ],
      ...
      children: [
        {
          ...
          children: [
            { name: 'App.tsx', path: 'src/app/App.tsx', isDir: false },
            {
              ...
              children: [
                {
                  name: 'ShellWindow.tsx',
                  path: 'src/app/shell/ShellWindow.tsx',
                  isDir: false,
                  gitStatus: 'added',
                },
                {
                  name: 'TerminalPane.tsx',
                  path: 'src/app/shell/TerminalPane.tsx',
                  isDir: false,
                  gitStatus: 'added',
                },
              ],
          ...
          children: [
            ...
            },
            {
              ...
              children: [
                ...
                {
                  name: 'node_groups.tf',
                  path: 'terraform/modules/eks/node_groups.tf',
                  isDir: false,
                  gitStatus: 'added',
                },
              ],
      ...
      children: [
        {
          ...
          children: [
            ...
            {
              name: 'multi-tenant.yaml',
              path: 'k8s/apps/multi-tenant.yaml',
              isDir: false,
              gitStatus: 'added',
            },
          ],
