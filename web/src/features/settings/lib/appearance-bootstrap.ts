...
const CROWBAR_DARK_COLORS: Record<string, string> = {
  "primary-bg": "#141413",
  "secondary-bg": "#1c1b19",
  text: "#faf9f5",
  "text-light": "#d7d3c6",
...
const CROWBAR_DARK_SYNTAX: Record<string, string> = {
  comment: "#8f8c82",
  keyword: "#d97757",
  string: "#6a9bcc",
  number: "#c89744",
...
const CROWBAR_LIGHT_COLORS: Record<string, string> = {
  "primary-bg": "#fcfcfd",
  "secondary-bg": "#f5f6f8",
  text: "#141413",
  "text-light": "#4b4f57",
...
const CROWBAR_LIGHT_SYNTAX: Record<string, string> = {
  comment: "#8f8c82",
  keyword: "#be664a",
  string: "#4f7fae",
  number: "#a67a35",
...
export const CROWBAR_BOOTSTRAP_DEFAULTS = {
  dark: {
    id: "crowbar-dark",
    type: "dark" as const,
    colors: CROWBAR_DARK_COLORS,
    syntax: CROWBAR_DARK_SYNTAX,
  },
  light: {
    id: "crowbar-light",
    type: "light" as const,
    colors: CROWBAR_LIGHT_COLORS,
    syntax: CROWBAR_LIGHT_SYNTAX,
  },
};
