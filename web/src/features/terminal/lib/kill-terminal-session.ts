...
// session entry, then closes the WS and DELETEs the chat-scoped
// /v0/chats/:chatId/terminals/:sessionId route (resolved from the base
// recorded for the session at create time, inside terminalClose).
