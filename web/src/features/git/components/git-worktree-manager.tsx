...
import { addWorktree, getWorktrees, pruneWorktrees, removeWorktree } from '../api/git-worktrees-api'
          ...
          actions={
            <>
              ...
              {hasPrunableWorktrees ? (
                ...
                >
                  {isLoading ? <LoadingSpinner label="Pruning worktrees" compact /> : <RefreshCw />}
                </Button>
              ) : null}
            </>
          }
              ...
              >
                <div className="min-w-0 flex-1">
                  <div className="flex min-w-0 items-center gap-2">
                    <span
                      className="truncate ui-text-sm text-foreground leading-4"
                      title={worktree.path}
                    >
                      {worktreeName}
                    </span>
