  ...
  return (
    ...
    >
      {effectiveZone && (
        <div
          className={cn(
            'pointer-events-none absolute border-2 border-secondary bg-secondary/14 shadow-[0_0_0_1px_color-mix(in_oklch,var(--color-secondary)_25%,transparent)] transition-all duration-100',
