    ...
    <div ref={tabRef} className="group/tab relative">
      ...
      {!buffer.isUncloseable && (
        <Button
          ...
          className={cn(
            "absolute inset-y-0 my-auto right-2 !size-3.5 !min-h-0 !min-w-0 grid place-items-center cursor-pointer select-none !rounded-md !p-0 text-muted-foreground transition-opacity",
