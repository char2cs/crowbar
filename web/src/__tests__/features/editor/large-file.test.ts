...
import { getUndoEditDelta } from '@/features/editor/history/undo-grouping'
...
describe('large file editor mode', () => {
  ...
  it('updates large-mode line offsets incrementally for small inserts', () => {
    ...
    const nextInfo = applyIncrementalLargeEditorModeInfo(previousContent, nextContent, previousInfo)
