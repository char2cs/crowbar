...
vi.mock('@/features/agent/tree/lib/chat-rows', async (importOriginal) => {
  const actual = await importOriginal<typeof import('@/features/agent/tree/lib/chat-rows')>()
  return {
    ...actual,
...
vi.mock('@/features/agent/shared/agent-chat-glyph', () => ({
...
import { AGENT_CHAT_ROW_HEIGHT } from '@/features/agent/tree/hooks/use-agent-chat-list-virtualizer'
import {
