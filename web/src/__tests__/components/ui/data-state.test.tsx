...
describe('DataState', () => {
  it('idle renders nothing', () => {
    const { container } = render(
      <DataState loadable={idle()} onRetry={() => {}}>
        {renderList}
      </DataState>,
    )
  ...
  it('loading with no stale shows a spinner', () => {
    render(
      <DataState loadable={loading(idle())} onRetry={() => {}} loadingLabel="Loading items">
        {renderList}
      </DataState>,
    )
  ...
  it('error with no stale shows inline error', () => {
    render(
      <DataState loadable={failed(new Error('x'), idle())} onRetry={() => {}}>
        {renderList}
      </DataState>,
    )
  ...
  it('success renders children with data', () => {
    render(
      <DataState loadable={success(['a', 'b'])} onRetry={() => {}}>
        {renderList}
      </DataState>,
    )
  ...
  it('success with empty data and emptyMessage shows the empty message', () => {
    render(
      <DataState loadable={success<string[]>([])} onRetry={() => {}} emptyMessage="Nothing here">
        {renderList}
      </DataState>,
    )
