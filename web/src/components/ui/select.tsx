...
export function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-oracle-id="select-trigger"
      data-slot="select-trigger"
      {...props}
    >
      {children}
      <SelectPrimitive.Icon data-oracle-id="select-icon" data-slot="select-icon">
...
export function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      data-oracle-id="select-item"
      data-slot="select-item"
      {...props}
    >
      <SelectPrimitive.ItemIndicator className="col-start-1" data-oracle-id="select-item-indicator">
        <svg
          aria-hidden="true"
          fill="none"
          height="24"
      ...
      <SelectPrimitive.ItemText className="col-start-2 min-w-0" data-oracle-id="select-item-text">
        {children}
