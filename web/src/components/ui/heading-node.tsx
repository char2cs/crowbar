...
const headingVariants = cva(
  'relative mb-1 data-[nav-target=true]:rounded-md data-[nav-target=true]:bg-(--color-highlight)',
  {
    variants: {
      variant: {
        h1: 'mt-[1.6em] pb-1 font-normal font-heading text-4xl',
        h2: 'mt-[1.4em] pb-px font-heading font-normal text-2xl tracking-tight',
        h3: 'mt-[1em] pb-px font-heading font-normal text-xl tracking-tight',
        h4: 'mt-[0.75em] font-heading font-normal text-lg tracking-tight',
