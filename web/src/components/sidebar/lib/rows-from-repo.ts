 ...
 */
function homeOwningChatId(chats: readonly Chat[], homeId: string): string {
...
function resolveOwnership(workspaces: readonly Workspace[], chats: readonly Chat[]): Ownership {
