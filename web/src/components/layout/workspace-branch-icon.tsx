...
export function WorkspaceBranchIcon({ status }: WorkspaceBranchIconProps) {
  ...
  switch (status) {
    case 'locked':
      return (
        <svg aria-hidden="true" className="size-4 shrink-0 text-foreground/30" viewBox="0 0 16 16" fill="currentColor">
    ...
    case 'pr-open':
      return (
        <svg aria-hidden="true" className="size-4 shrink-0 text-green-500" viewBox="0 0 16 16" fill="currentColor">
    ...
    case 'pr-closed':
      return (
        <svg aria-hidden="true" className="size-4 shrink-0 text-red-500" viewBox="0 0 16 16" fill="currentColor">
          <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06z" />
        </svg>
      )
    case 'pr-merged':
      return (
        <svg aria-hidden="true" className="size-4 shrink-0 text-purple-500" viewBox="0 0 16 16" fill="currentColor">
...
export function WorkspaceAgentSpinner() {
  ...
  return (
    <span className="size-4 shrink-0 text-violet-400 leading-none flex items-center justify-center">
      <Spinner name={name} color="currentColor" size="0.875rem" />
    </span>
  )
}
