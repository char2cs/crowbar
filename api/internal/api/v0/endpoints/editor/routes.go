...
func mount(
	...
	rg.POST(prefix+"/lsp/semanticTokens", h.SemanticTokens)
	rg.POST(prefix+"/lsp/semanticTokensRange", h.SemanticTokensRange)
	rg.POST(prefix+"/lsp/executeCommand", h.ExecuteCommand)
