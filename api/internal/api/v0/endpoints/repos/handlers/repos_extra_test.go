...
func (f *fakeWSRemover) DeleteRepoWorkspaces(_ context.Context, repoID, repoPath string) error {
...
func (f *failingWSRemover) DeleteRepoWorkspaces(_ context.Context, _, _ string) error {
