...
func TestCreateChild_ResolveSlugRepoLookupError(t *testing.T) {
	g := &fakeGit{}
	uc := worktree.New(&fakeWorkspace{}, g, &fakeProvider{}, &fakeRepoStore{err: errBoom}, newNow(), fakeHome())
	_, err := uc.CreateChild(context.Background(), worktree.CreateChildInput{
		RepoID: "r1", ProjectID: "p1", RepoPath: "/repo", Branch: "feature/x", ParentBranch: "develop",
	})
	require.ErrorIs(t, err, errBoom)
...
func TestCreateChild_ResolveSlugRepoNotFound(t *testing.T) {
	g := &fakeGit{}
	uc := worktree.New(&fakeWorkspace{}, g, &fakeProvider{}, &fakeRepoStore{missing: true}, newNow(), fakeHome())
	_, err := uc.CreateChild(context.Background(), worktree.CreateChildInput{
		RepoID: "r1", ProjectID: "p1", RepoPath: "/repo", Branch: "feature/x", ParentBranch: "develop",
	})
...
func TestCreateChild_SiblingWorktreePaths_NotADirectory(t *testing.T) {
	...
	g := &fakeGit{}
	uc := worktree.New(&fakeWorkspace{}, g, &fakeProvider{}, &fakeRepoStore{},
