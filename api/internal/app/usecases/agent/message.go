...
// stream lock is held. It is the ONLY shape messageStreams hands out: the termwait
// sweep goroutine reads a message at the same instant a hook goroutine appends
// increments to it, so a shared *messageBuffer was a concurrent map read and map
