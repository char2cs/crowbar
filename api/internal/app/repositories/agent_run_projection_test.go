...
func TestAgentRunProjection_DrivesChatStatus(t *testing.T) {
	...
	require.NoError(t, repositories.RegisterAgentRunProjection(ax, fakeChat, refresh))
...
func TestAgentRunProjection_TerminalErrorAndInterrupted(t *testing.T) {
	...
	ax, runs := newAgentRunAsynx(t)
	fakeChat := &captureChatRepo{}
	require.NoError(t, repositories.RegisterAgentRunProjection(ax, fakeChat, func(context.Context, string) {}))
...
func TestAgentRunProjection_SubscribeErrorReturned(t *testing.T) {
	...
	err = repositories.RegisterAgentRunProjection(ax, &captureChatRepo{}, func(context.Context, string) {})
	assert.Error(t, err)
}
