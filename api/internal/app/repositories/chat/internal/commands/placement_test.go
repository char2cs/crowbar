...
var (
	_ asynxModels.Command[domain.Chat] = commands.SetPlacement{}
	_ asynxModels.Command[domain.Chat] = commands.SetOrder{}
)

func TestSetPlacement_WritesBothHalvesOfThePlacement(t *testing.T) {
	chat := &domain.Chat{ID: "c1", ParentID: "old", Order: 3}
...
func TestSetPlacement_AnEmptyParentIsTheRoot(t *testing.T) {
	chat := &domain.Chat{ID: "c1", ParentID: "p1"}
...
func TestSetOrder_LeavesTheParentExactlyAsTheLogHasIt(t *testing.T) {
	chat := &domain.Chat{ID: "c1", ParentID: "p1", Order: 0}
...
func TestSetOrder_LeavesAChatAtTheRootAtTheRoot(t *testing.T) {
	chat := &domain.Chat{ID: "c1", Order: 4}
...
func TestSetOrder_AcceptsTheFirstSlot(t *testing.T) {
	assert.NoError(t, commands.SetOrder{ID: "c1", Order: 0}.Validate(&domain.Chat{ID: "c1"}))
}
