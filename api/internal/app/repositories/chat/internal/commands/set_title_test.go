...
var _ asynxModels.Command[domain.Chat] = commands.SetTitle{}

func TestSetTitle_LockedRejectsDerived(t *testing.T) {
	chat := &domain.Chat{ID: "c1", Title: "User Title", TitleLocked: true}
...
func TestSetTitle_UserSourceLocksTitle(t *testing.T) {
	chat := &domain.Chat{ID: "c1", Title: "old", TitleLocked: false}
...
func TestSetTitle_UserCanOverrideLocked(t *testing.T) {
	chat := &domain.Chat{ID: "c1", Title: "Locked", TitleLocked: true}
