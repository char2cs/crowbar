...
func (c Interrupt) Validate(*domain.ChatActivity) error {
...
func (c Interrupt) EmitEvent(current *domain.ChatActivity) domain.ChatActivity {
...
func (c ResolveInterruption) Validate(*domain.ChatActivity) error {
...
func (c ResolveInterruption) EmitEvent(current *domain.ChatActivity) domain.ChatActivity {
	next := advance(current, c.ChatID)
