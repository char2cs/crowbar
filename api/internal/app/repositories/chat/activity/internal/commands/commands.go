...
func advance(current *domain.ChatActivity, chatID string) domain.ChatActivity {
	if current == nil {
		return domain.ChatActivity{ChatID: chatID, Seq: 1}
	}
	next := *current
	next.ChatID = chatID
...
func full(a *domain.ChatActivity) bool {
