...
func (c OpenChoice) Validate(*domain.ChatActivity) error {
...
func (c OpenChoice) EmitEvent(current *domain.ChatActivity) domain.ChatActivity {
...
func gatedTool(a *domain.ChatActivity, toolName string) string {
	if toolName == "" {
		return ""
	}
	found := ""
...
func dropChoicesForTool(a *domain.ChatActivity, toolID, toolName string) {
...
func (c ResolveChoice) EmitEvent(current *domain.ChatActivity) domain.ChatActivity {
	next := advance(current, c.ChatID)
