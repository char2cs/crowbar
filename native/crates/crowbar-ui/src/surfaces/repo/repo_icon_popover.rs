...
impl PopupContent {
    ...
    /// This box reproduces [`crate::primitives::input::ID_CONTROL`]/[`crate::primitives::input::
    ...
    fn emoji_row(theme: &Theme, anchors: &dyn AnchorSink) -> Div {
        let field = anchors.boxed(
            AnchorId::from(crate::primitives::input::ID_FIELD),
            div().w_full().h_full(),
        );
        let input = anchors.boxed(
            AnchorId::from(crate::primitives::input::ID_CONTROL),
            div()
                .relative()
                .flex_1()
                .h(EMOJI_ROW_HEIGHT)
...
mod tests {
    ...
    use crate::primitives::popover;
    use crate::surfaces::repo::repo_avatar::Kind;
