...
mod tests {
    ...
    use crate::surfaces::rows::{ContentLength, RowState};
    ...
    fn the_indent_step_is_sixteen_not_the_sidebar_trees_fourteen() {
        ...
        assert_ne!(INDENT_SIZE, crate::surfaces::rows::INDENT_SIZE);
    ...
    fn the_wrapper_background_is_the_shared_unscoped_rule() {
        ...
        assert_eq!(
            crate::surfaces::rows::item_background(&theme, RowState::resting()),
            None,
        );
        assert_eq!(
            crate::surfaces::rows::item_background(
                &theme,
                RowState {
                    selected: true,
                    ..RowState::resting()
