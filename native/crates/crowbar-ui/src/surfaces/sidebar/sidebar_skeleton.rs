...
//! `<Skeleton>` — already ported as [`crate::primitives::skeleton`] — across
//! **five** distinct box shapes, two more than that module's own
//! [`crate::primitives::skeleton::CallSite`] enum names. See §2 below for
...
//! **public values** — [`crate::primitives::skeleton::RADIUS_CALL_SITE`] and
...
use crate::primitives::skeleton::RADIUS_CALL_SITE;
