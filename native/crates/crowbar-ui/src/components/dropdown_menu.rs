...
/// and [`crate::components::dropdown_menu`]'s consumer pins it against a live
/// layout.
...
///
/// The enum is [`super::ContentLength`] — the matrix's own vocabulary, shared
...
#[must_use]
pub const fn label(content: super::ContentLength) -> &'static str {
    match content {
        super::ContentLength::Short => "Edit",
        super::ContentLength::Normal => "Copy as Markdown",
        super::ContentLength::Overflow => {
        ...
        Self {
            ...
            entries: vec![
                MenuEntry::Row(MenuRow::item(
                    "menu-item-edit",
                    label(super::ContentLength::Short),
                )),
...
mod tests {
    ...
    use crate::components::ContentLength;
    use crate::theme::{Color, Theme};
    use gpui::px;
