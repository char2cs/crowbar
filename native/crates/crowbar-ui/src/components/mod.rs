...
pub use git_status_row::{
    ContentLength, GitStatusRow, ID_ADDED, ID_BADGE, ID_BUTTON, ID_DELETED, ID_DIR, ID_ICON,
    ID_ITEM, ID_NAME, NAME_MAX_FRACTION, NameSizing, TrailingContent, guide_id, name_sizing,
