...
mod tests {
    ...
    use crate::components::input::Size as InputSize;
    ...
    fn both_themes_render_the_fixture() {
        for theme in [Theme::LIGHT, Theme::DARK] {
            let _ = Input::fixture().render(&theme, &crate::components::Unanchored);
            let _ = List::fixture().render(&theme, &crate::components::Unanchored);
        }
    }
}
